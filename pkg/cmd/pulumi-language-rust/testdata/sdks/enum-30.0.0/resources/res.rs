...
pub mod res {
    ...
    pub struct ResArgs {
        ...
        pub int_enum: pulumi_gestalt_rust::InputOrOutput<Option<super::types::IntEnum>>,
        #[builder(into, default)]
    ...
    pub struct ResResult {
        ...
        pub int_enum: pulumi_gestalt_rust::Output<Option<super::types::IntEnum>>,
