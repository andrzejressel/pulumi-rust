...
pub struct ProviderArgs {
    ...
    pub elide_unknowns: pulumi_gestalt_rust::InputOrOutput<Option<bool>>,
}
#[allow(dead_code)]
...
pub fn create_with_options(
    ...
    let elide_unknowns_binding = args.elide_unknowns.get_output(context);
    let request = pulumi_gestalt_rust::RegisterResourceRequest {
        type_: "pulumi:providers:output".into(),
        name: name.to_string(),
        version: super::get_version(),
        object: &[
            pulumi_gestalt_rust::ResourceRequestObjectField {
                name: "elideUnknowns".into(),
                value: &elide_unknowns_binding.drop_type(),
            },
        ],
        options,
    };
